...
inherit webapp git-2 versionator eutils
...
[[ ${PV} == "9999" ]] || EGIT_COMMIT=${PV/_rc/-alpha}

LICENSE="GPL-2"
KEYWORDS="~amd64 ~ppc ~sparc ~x86"
IUSE="aac aacp flac mp3 ogg transcode"
